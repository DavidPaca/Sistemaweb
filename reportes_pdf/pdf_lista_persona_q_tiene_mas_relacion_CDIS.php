...
WHERE tbl_inter_ei_relacion_ninio.id_parentesco_rn = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $num_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $num_per ORDER BY apellidos ASC"; 
