...
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_gustos_ninio.id_ninio_gn
INNER JOIN tbl_gustos_disgustos
ON tbl_gustos_disgustos.id_gustos_disgustos = tbl_inter_ei_gustos_ninio.id_gustos_gn
WHERE tbl_inter_ei_gustos_ninio.id_gustos_gn = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Gustos'), 0, 0, 'C');  
$pdf -> Ln(10);
