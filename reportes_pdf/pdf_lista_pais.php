...
tbl_pais.id_pais, tbl_pais.detalle AS detalle_paises
FROM tbl_datos_personales_ninio 
INNER JOIN tbl_pais
ON tbl_pais.id_pais = tbl_datos_personales_ninio.pais
WHERE tbl_datos_personales_ninio.pais = $repor_id AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Nacionalidad'), 0, 0, 'C');  
$pdf -> Ln(10);
