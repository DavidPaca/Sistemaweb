...
tbl_etnia.id_etnia, tbl_etnia.detalle AS detalle_etnia
FROM tbl_datos_personales_ninio 
INNER JOIN tbl_etnia
ON tbl_etnia.id_etnia = tbl_datos_personales_ninio.id_etnia
WHERE tbl_datos_personales_ninio.id_etnia = $repor_id AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Étnia'), 0, 0, 'C');  
$pdf -> Ln(10);
