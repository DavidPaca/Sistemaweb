...
tbl_alimentos.detalle, tbl_alimentos.id_alimentos
FROM tbl_inter_ei_rechaza_alimento_disgusta
INNER JOIN tbl_datos_personales_ninio 
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_rechaza_alimento_disgusta.id_ninio_rech_ali
INNER JOIN tbl_alimentos
ON tbl_alimentos.id_alimentos = tbl_inter_ei_rechaza_alimento_disgusta.id_alimentos_rech_ali
WHERE tbl_inter_ei_rechaza_alimento_disgusta.id_alimentos_rech_ali = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Alimentos que rechaza'), 0, 0, 'C');  
$pdf -> Ln(10);
