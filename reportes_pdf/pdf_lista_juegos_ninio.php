...
tbl_datos_personales_ninio.nombres, tbl_juegos.id_juegos, tbl_juegos.detalle
FROM tbl_inter_ei_juegos_del_ninio
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_juegos_del_ninio.id_ninio_jn
INNER JOIN tbl_juegos
ON tbl_juegos.id_juegos = tbl_inter_ei_juegos_del_ninio.id_juegos_jn
WHERE tbl_inter_ei_juegos_del_ninio.id_juegos_jn = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Juegos'), 0, 0, 'C');  
$pdf -> Ln(10);
