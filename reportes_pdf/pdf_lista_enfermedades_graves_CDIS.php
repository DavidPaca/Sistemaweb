...
WHERE tbl_inter_ei_enfermedades_graves.id_enfermedades_graves_eg = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $num_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $num_per ORDER BY apellidos ASC"; 
