...
WHERE tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo AND tbl_datos_personales_ninio.estado = 'Activo' ORDER BY apellidos ASC "; 
...
$pdf -> Cell(61, -40, "$inic $finc", 0, 0, 0);
//}
$pdf -> Ln(-5);
