...
tbl_enfermedades.id_enfermedades, tbl_enfermedades.detalle
FROM tbl_inter_ei_enfermedades_graves
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_enfermedades_graves.id_ninio_eg
...
WHERE tbl_inter_ei_enfermedades_graves.id_enfermedades_graves_eg = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC "; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Enfermedades graves'), 0, 0, 'C');  
$pdf -> Ln(10);
