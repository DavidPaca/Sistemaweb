...
tbl_datos_personales_ninio.nombres, tbl_vocabulario.id_vocabulario, tbl_vocabulario.detalle
FROM tbl_entrevista_inicial
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_entrevista_inicial.id_ninio
INNER JOIN tbl_vocabulario
ON tbl_vocabulario.id_vocabulario = tbl_entrevista_inicial.vocabulario_ninio
WHERE tbl_entrevista_inicial.vocabulario_ninio = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Vocabulario'), 0, 0, 'C');  
$pdf -> Ln(10);
