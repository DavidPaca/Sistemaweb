...
tbl_alergias.id_alergias, tbl_alergias.detalle
FROM tbl_inter_ei_es_alergico
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_es_alergico.id_ninio_ea
INNER JOIN tbl_alergias
ON tbl_alergias.id_alergias = tbl_inter_ei_es_alergico.id_alergia_ea
WHERE tbl_inter_ei_es_alergico.id_alergia_ea = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Alérgias'), 0, 0, 'C');  
$pdf -> Ln(10);
