...
tbl_datos_personales_ninio.nombres, tbl_intervensionesq.id_intervensionesq, tbl_intervensionesq.detalle
FROM tbl_inter_ei_intervensiones_quirugicas
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_intervensiones_quirugicas.id_ninio_iq
...
WHERE tbl_inter_ei_intervensiones_quirugicas.id_intervensiones_q_iq = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Intervenciones quirúrgicas'), 0, 0, 'C');  
$pdf -> Ln(10);
