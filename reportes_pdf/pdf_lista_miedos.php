...
tbl_datos_personales_ninio.nombres, tbl_miedos.id_miedos, tbl_miedos.detalle
FROM tbl_inter_ei_miedos_ninio
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_miedos_ninio.id_ninio_miedosn
INNER JOIN tbl_miedos
ON tbl_miedos.id_miedos = tbl_inter_ei_miedos_ninio.id_miedos_miedosn
WHERE tbl_inter_ei_miedos_ninio.id_miedos_miedosn = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Miedos'), 0, 0, 'C');  
$pdf -> Ln(10);
