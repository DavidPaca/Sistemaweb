...
tbl_datos_personales_ninio.nombres, tbl_mascotas.id_mascota, tbl_mascotas.detalle
FROM tbl_inter_ei_tiene_mascotas
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_tiene_mascotas.id_ninio_tm
INNER JOIN tbl_mascotas
ON tbl_mascotas.id_mascota = tbl_inter_ei_tiene_mascotas.id_mascotas_tm
WHERE tbl_inter_ei_tiene_mascotas.id_mascotas_tm = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Mascotas'), 0, 0, 'C');  
$pdf -> Ln(10);
