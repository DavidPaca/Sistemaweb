...
tbl_accidentes.id_accidentes, tbl_accidentes.detalle
FROM tbl_inter_ei_sifrio_accidentes
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_sifrio_accidentes.id_ninio_sa
INNER JOIN tbl_accidentes
ON tbl_accidentes.id_accidentes = tbl_inter_ei_sifrio_accidentes.id_accidentes_sa
WHERE tbl_inter_ei_sifrio_accidentes.id_accidentes_sa  = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Accidentes'), 0, 0, 'C');  
$pdf -> Ln(10);
