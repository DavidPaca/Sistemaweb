...
WHERE tbl_inter_ei_enfermedades_padecio.id_enfermedades_padecio_ep = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodoORDER BY apellidos ASC"; 
