...
tbl_medicamentos.id_medicamentos, tbl_medicamentos.detalle
FROM tbl_inter_ei_toma_medicamentos
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_inter_ei_toma_medicamentos.id_ninio_tm
INNER JOIN tbl_medicamentos
ON tbl_medicamentos.id_medicamentos = tbl_inter_ei_toma_medicamentos.id_medicamentos_tm
WHERE tbl_inter_ei_toma_medicamentos.id_medicamentos_tm = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Medicamentos'), 0, 0, 'C');  
$pdf -> Ln(10);
