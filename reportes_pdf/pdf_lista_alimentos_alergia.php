...
tbl_alimentos.id_alimentos, tbl_alimentos.detalle
FROM tbl_rechaza_alimentos
INNER JOIN tbl_datos_personales_ninio
ON tbl_datos_personales_ninio.id_ninio = tbl_rechaza_alimentos.id_ninio
INNER JOIN tbl_alimentos
ON tbl_alimentos.id_alimentos = tbl_rechaza_alimentos.id_alimentos
WHERE tbl_rechaza_alimentos.id_alimentos = $id_alimento AND tbl_datos_personales_ninio.id_cdi = $_nom_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $_nom_periodo ORDER BY apellidos ASC"; 
...
$pdf -> Cell(30);  
$pdf -> Cell(120, 10, utf8_decode('Alérgias a los alimentos'), 0, 0, 'C');  
$pdf -> Ln(10);
