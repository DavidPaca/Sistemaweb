...
tbl_datos_personales_ninio.id_cdi, tbl_cdi.nombre AS detalle_cdi
                    ...
                    Where tbl_datos_personales_ninio.estado ='Activo' AND tbl_datos_personales_ninio.id_ninio = $edit_id AND tbl_datos_personales_ninio.id_cdi = $num_cdi AND tbl_datos_personales_ninio.id_periodo_ninio = $num_per";
...
while ($row = mysqli_fetch_array($resultado3)){
  ...
  $pdf -> Cell(50, 8, utf8_decode($anio_ninio.' año(s)  '. $mes_ninio. ' mes(es)  '. $dia_ninio. ' día(s)'  ), 1, 0, 1 );  
