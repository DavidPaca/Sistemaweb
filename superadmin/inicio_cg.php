...
require_once('../superadmin/inc/top.php');//llamar archivos
...
<?php 
require_once('../superadmin/inc/header.php');
...
?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                   <h1><i class="fa fa-tachometer"></i> INICIO CG <small> Administración</small></h1><hr>
                    <ol class="breadcrumb">
