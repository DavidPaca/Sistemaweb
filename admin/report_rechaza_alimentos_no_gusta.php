    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-apple-alt"></i> Alimentos que rechaza el niño </h1><hr>
                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="../reportes_pdf/pdf_lista_alimentos_rechaza_no_gusta.php?edit=<?php echo $alimento_id; ?>" target="_blank" class="btn btn-primary">Reporte</i></a></center></td>
