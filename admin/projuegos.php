                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"><br>
                            <?php
                            $get_query = "SELECT * FROM tbl_juegos ORDER BY id_juegos DESC";
                                ...
                                <table class="table table-hover table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $juegos_id; ?></td>
                                                <td><?php echo ucfirst($detallejuegos_name); ?></td>
                                                <td><a href="projuegos.php?edit=<?php echo $juegos_id; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="projuegos.php?del=<?php echo $juegos_id; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
