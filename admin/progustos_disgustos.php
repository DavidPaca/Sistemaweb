                            ...
                            if (isset($_GET['edit'])) {
                                ...
                                if (mysqli_num_rows($edit_check_run) > 0) {
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <a href="progustos_disgustos.php">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="progustos_disgustos.php?edit=<?php echo $vocabulario_id; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="progustos_disgustos.php?del=<?php echo $vocabulario_id; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
