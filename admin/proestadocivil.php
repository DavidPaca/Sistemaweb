                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"><br>
                            <?php
                            $get_query = "SELECT * FROM tbl_estado_civil ORDER BY id_estado_civil DESC";
                                ...
                                <table class="table table-hover table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $estadocivil_id; ?></td>
                                                <td><?php echo ucfirst($detalleestcivil_name); ?></td>
                                                <td><a href="proestadocivil.php?edit=<?php echo $estadocivil_id; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="proestadocivil.php?del=<?php echo $estadocivil_id; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
