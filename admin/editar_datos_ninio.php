...
<!--............................................Fecha nacimiento........................................................-->
                                <div class="form-group">
                                    <div class="row">                                       
                                        ...
                                        <a href="editar_ninio_fecha_nac.php?edit=<?php echo $idninio; ?>">
       ...
       <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">                                       
                            ...
                            <a href="editar_ninio_lugar_nacimiento_ninio.php?edit=<?php echo $idninio; ?>">
...
<!--............................................Discapacidad........................................................-->
                    ...
                    <div class="form-group">
                        <div class="row">                                       
                            ...
                            <a href="editar_ninio_discapacidad.php?edit=<?php echo $idninio; ?>">
...
<!--............................................CDI.......................................................-->                                
                                <div class="form-group">                      
                                  <label for="cdi_ninio">Nombre de CDI:</label>
                                    <select class="form-control" name="cdi_ninio" id="cdi_ninio">
                                        <?php        
                                        
                                            $sql_cdis = "select * from tbl_cdi where id !=100 AND id != 102 AND id != 101";
                                            $ejecutar_cdis = mysqli_query($con, $sql_cdis);//ejecutar consulta
                                            
                                            $sql_llenarcdis = "SELECT tbl_datos_personales_ninio.id_cdi, tbl_cdi.nombre 
                                            FROM tbl_datos_personales_ninio 
                                            INNER JOIN tbl_cdi 
                                            ON tbl_datos_personales_ninio.id_cdi = tbl_cdi.id 
                                            WHERE id_ninio = $edit_id AND tbl_cdi.id !=100";
