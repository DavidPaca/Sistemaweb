    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-address-book"></i> Detalle <small> Socioeconómica</small></h1><hr>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <center>
                            <a href="editar_socio_eco.php?edit=<?php echo $id_ninio_se; ?>" class="btn btn-primary">Editar</a>
                            <a href="nisocioeconomico.php">
                                <button type="button" class="btn btn-primary">Regresar</button>
                            </a>

                            <a href="../reportes_pdf/pdf_impri_perfil_socio_economica.php?edit=<?php echo $edit_id; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" target="_blank">
