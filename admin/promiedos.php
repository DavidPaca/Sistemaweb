                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="promiedos.php?edit=<?php echo $vocabulario_id; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="promiedos.php?del=<?php echo $vocabulario_id; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
