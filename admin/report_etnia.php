    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-file-pdf"></i> Étnia </h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fas fa-home"></i> Menú</a></li>
                        <li><a href="menuprincipal_reportes.php"><i class="fa fa-list-ul"></i> Lista de Reportes</a></li>
                    </ol>
                    ...
                    <div class="row">                
                        <div class="col-md-6"><br>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="example" >
                                <tr>
                                    <th>Reporte general de las étnias</th>
                                    <th><center>Reporte</center></th>        
                                </tr>
                                <tr>
                                    <td><?php echo "Generar reporte" ?></td>
                                    <td><center><a href="../reportes_pdf/pdf_lista_etnia_reporte_general.php?numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" target="_blank" class="btn btn-primary btn-sm">Reporte</i></a></center></td>
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="../reportes_pdf/pdf_lista_etnia.php?edit=<?php echo $repor_id; ?>" target="_blank" class="btn btn-primary btn-sm">Reporte</i></a></center></td>
