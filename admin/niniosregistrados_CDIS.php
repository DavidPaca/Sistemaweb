                                        ...
                                        <tr>
                                          ...
                                          <!--  <td><?php //echo $ni_discapacidad; ?></td>
                                           ...
                                           <td><a href="profile_datos_ninio_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-file-alt"></i></a></td>
                                            <td><a href="editar_datos_ninio_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-edit"></i></a></td>
                                            <td><a href="niniosregistrados_CDIS.php?del=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
