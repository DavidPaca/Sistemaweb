                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                          ...
                          <!--  <table class="table table-bordered">                                               
                            ...
                            <table class="table table-bordered">
                                <label for="nom_lenguaje" style="font-size:1.5rem; color:#2174AB">LENGUAJE</label>
                                <tr>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                    <?php 
                                    $sql_muestra = "SELECT tbl_usuario.apellidos, tbl_usuario.nombres
                                    from tbl_entrevista_inicial
                                ...
                                <tr>
                                    ...
                                    <td width="30%"><?php 
                                    $sql_most = "SELECT tbl_usuario_nombre.detalle
                                    from tbl_entrevista_inicial
                            ...
                            <center>
                            <a href="editar_entrevista_inicial.php?edit=<?php echo $id_ninio_ei; ?>" class="btn btn-primary">Editar</a> 
                            <a href="nientrevistaregistrada.php">
                                <button type="button" class="btn btn-primary">Regresar</button>
                            </a>

                            <a href="../reportes_pdf/pdf_impri_perfil_entrevista_inicial.php?edit=<?php echo $id_ninio_ei; ?>" target="_blank">
