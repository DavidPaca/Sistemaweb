            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <li><a href="index.php"><i class="fas fa-chevron-left"></i> Regresar</a></li> 
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                          ...
                                          <!--  <td><?php //echo $ni_discapacidad; ?></td>
                                           ...
                                           <td><center><a href="../reportes_pdf/pdf_ac_las_vacunas.php?edit=<?php echo $idninio; ?>" target="_blank" class="btn btn-primary btn-sm">Generar</i></a></center></td>
