                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="proparentesco.php?edit=<?php echo $medica_id; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="proparentesco.php?del=<?php echo $medica_id; ?>" onclick="return confirm('¿Desea Borrar?');  "><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
