                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="proocupacion.php?edit=<?php echo $id_vivi; ?>"><i class="far fa-edit"></i></a></td>
                                                <td><a href="proocupacion.php?del=<?php echo $id_vivi; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
