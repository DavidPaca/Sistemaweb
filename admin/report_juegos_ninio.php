    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-file-pdf"></i> Juegos </h1><hr>
                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="../reportes_pdf/pdf_lista_juegos_ninio.php?edit=<?php echo $repor_id; ?>" target="_blank" class="btn btn-primary btn-sm">Reporte</i></a></center></td>
