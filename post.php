...
if (isset($_GET['post_id'])) {
   ...
   /* $views_query = "UPDATE `tbl_eventos` SET `views` = views + 1 WHERE `posts`.`id` = $post_id";
    mysqli_query($con, $views_query);*/

    $query = "SELECT * FROM tbl_eventos WHERE estado = 'publico' and id_eventos = $post_id";
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="related-posts">
                    ...
                    <div class="row">
                        <?php
                        $r_query = "SELECT * FROM tbl_eventos WHERE estado = 'publico' AND titulo LIKE '%$title%' LIMIT 3";
                        $r_run = mysqli_query($con, $r_query);
                        while ($r_row = mysqli_fetch_array($r_run)) {
                            $r_id = $r_row['id_eventos'];
                            $r_title = $r_row['titulo'];
                            $r_image = $r_row['imagen_evento'];
                            ?>
                            <div class="col-sm-4">
