    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-apple-alt"></i> Enfermedades Graves </h1><hr>
                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="../reportes_pdf/pdf_lista_enfermedades_graves_CDIS.php?edit=<?php echo $alimento_id; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" target="_blank" class="btn btn-primary">Reporte</i></a></center></td>
