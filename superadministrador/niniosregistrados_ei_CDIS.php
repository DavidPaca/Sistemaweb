...
<body>
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                <div class="col-md-3">
                     <?php require_once('../admin/inc/sidebar.php'); ?>  <!-- fal fa-clipboard-user, far fa-clipboard-user,fas fa-clipboard-user        -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <script type = "text/javascript">
                                              function habilitar(){
                                                  var deshabit = document.getElementById("block_edit");
                                                  var id_ninio_block = document.getElementById("id_de_ninios");

                                                  if(id_ninio_block.value == $edit_id ){
                                                    deshabit.disabled = true;
                                                  } else{
                                                    deshabit.disabled = false;  
                                                  }
                                              }  
                                        </script>    
                                        ...
                                        <tr>
                                           ...
                                           <!-- <td><?php // echo $idTipodocumento; ?></td> -->
                                            ...
                                            <?php
                                        if ($estado_en_inicial == 0){ ?>
                                            <td><a href="ing_entrevista_i_SU_AD.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i id = "block_edit" class="far fa-file-alt"></i></a></td>
                                            <?php  } else{ ?>
                                               <td><i id = "block_edit" class="far fa-file-alt"></i></td> 
                                               <?php    }  ?>
                                          
                                            
                                               <!--      <td><a href="niniosregistrados_ei_CDIS.php?del=<?php //echo $idninio; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>  --> 
                                            
                                                        
                                        </tr>
                                    <?php } ?>
                                    <input type="hidden" name="id_de_ninios" id = "id_de_ninios" value= "<?php echo $idninio ?>">
