                                    ...
                                    ?>
                                        ...
                                        <tr>
                                          ...
                                          <!--  <td><?php //echo $ni_discapacidad; ?></td>
                                           ...
                                           <td><a href="profile_socio_eco_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-file-alt"></i></a></td>  
                                            <?php  } else{ ?>
                                            ...
                                            ?>  
                                             <?php
                                        if ($estado_socio_ec == 1){ ?>
                                            <td><a href="editar_socio_eco_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-edit"></i></a></td>
                                            ...
                                            <td><a href="nisocioeconomico_CDIS.php?del=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
