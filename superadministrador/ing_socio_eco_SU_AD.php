            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                         ...
                         <li><a href="niniosregistrados_ing_se_CDIS.php?numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="fas fa-chevron-left"></i> Regresar</a></li>
...
/*---------------------------Guarda los datos ingresados en los cajones en las variables------------------------------------------*/
                    if (isset($_POST['submit'])) {
                        ...
                        if ($_POST['especifique_actividad'] == null){
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <span class="input-group-addon">$</span>
                                                <input type="text" id="ingreso_mensual" name="ingreso_mensual" maxlength="10" type="range" min="1" max="100" type="range" class="form-control" value="" placeholder="000.00" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                                <input type="text" id="egreso_mensual" name="egreso_mensual"  maxlength="10" type="range" min="1" max="100" type="range" class="form-control" value="" placeholder="000.00" >
