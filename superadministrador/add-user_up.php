    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-user-plus"></i> Agregar<small> Unidad de Proyectos </small></h1><hr>
                    <ol class="breadcrumb">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                             ...
                             <!--   <div class="form-group">
                                ...
                                <label for="role">Tipo de usuario :</label>
                                    ...
                                    <option value="" >Seleccione</option>
                                        <?php
                                            $sql_usuario_nom = "SELECT * FROM `tbl_usuario_nombre` WHERE id_usuario_nombre != 1 AND id_usuario_nombre != 4 AND id_usuario_nombre != 5 AND id_usuario_nombre != 3 AND id_usuario_nombre != 2 ";
                                ...
                                <input type="hidden" name="cdi" id = "cdi" value= 102>
...
<!--XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX PERIODO XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXx-->                                
                               
                                <input type="hidden" name="periodo_acad" id = "periodo_acad" value= 1>
