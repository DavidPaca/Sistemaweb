    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-image"></i> Editar <small>Fotografía</small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fas fa-home"></i> Menú</a></li>
                        <li class="active"><i class="fas fa-image"></i> Fotografía</li>
                    </ol>
                    <?php
                    if (isset($_POST['submit'])) {
                      ...
                      /*  $fecha_ingres = ( $_POST['fecha_ing']);     
                        $pass = ( $_POST['password']);     
                        $rol_us = ( $_POST['role']);
                        $email =  ($_POST['email']);
                        $telef = ($_POST['telef']);
                        $dir = ($_POST['dir']);
                        $cdi_usu = ($_POST['cdi_us']);
                        $periodo_us = ($_POST['periodous']);
                        $estado_usu = ($_POST['estadous']);*/
...
/*----------------------empty =vacio--------------------------*/
                      ...
                      //  } else {
                            $insert_query = "UPDATE `tbl_usuario` SET `imagen_usuario` = '$image' where `id_usuario` = '$edit_id'";
                    ...
                    <div class="row">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                              ...
                              <!--  <div class="form-group">
                                    ...
                                    <input type="text" id="tipo_docid" name="tipo_docid" class="form-control" placeholder="Role" value="<?php //echo( $row["id_docide"]);?>">
                                </div>
                                
                                <div class="form-group">
                                            <label for="Password">Contraseña :</label>   
                                    <input type="text" id="role" name="role" class="form-control" placeholder="Role" value="<?php //echo( $row["tipo"]);?>">
                                </div>

                                <div class="form-group">
                                            <label for="Password">Contraseña :</label>  
                                    <input type="text" id="fecha_ing" name="fecha_ing" class="form-control" placeholder="fecha ingreso" value="<?php //echo( $row["fecha_ingreso"]);?>">
                                </div>

                                <div class="form-group">
                                            <label for="Password">Contraseña :</label>   
                                    <input type="text" id="password" name="password" class="form-control" placeholder="Password" value="<?php //echo( $row["contrasenia"]);?>">
                                </div>

                                <div class="form-group">
                                            <label for="Password">Contraseña :</label>   
                                    <input type="text" id="cdi_us" name="cdi_us" class="form-control" placeholder="CDI" value="<?php //echo( $row["id_cdi"]);?>">
                                </div>

                                  <div class="form-group">  
                                    <label for="Password">Contraseña :</label>   
                                    <input type="text" id="periodous" name="periodous" class="form-control" placeholder="Periodo" value="<?php //echo( $row["id_periodo_usuario"]);?>">
                                  </div>

                                <div class="form-group"> 
                                    <label for="Password">Contraseña :</label>   
                                    <input type="text" id="estadous" name="estadous" class="form-control" placeholder="Estado" value="<?php //echo( $row["estado_us"]);?>">
                                </div>  
