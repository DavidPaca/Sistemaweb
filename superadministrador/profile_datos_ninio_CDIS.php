            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="niniosregistrados_CDIS.php?numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="fas fa-chevron-left"></i> Regresar</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <center><img src="../admin/img/<?php echo $imagen_n; ?>" width="150px" class="rounded" id="profile-image"></center>
                          ...
                          <?php } else { ?>
                            <a href="editar_datos_ninio_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" class="btn btn-primary">Editar Datos</a>
                            
                            <a href="editar_ninio_fotografia_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>">
                            ...
                            <a href="../reportes_pdf/pdf_impri_datos_personales_ninio_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"target="_blank">
