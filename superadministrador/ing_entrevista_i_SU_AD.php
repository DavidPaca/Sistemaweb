            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="niniosregistrados_ei_CDIS.php?numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="fas fa-chevron-left"></i> Regresar</a></li>
...
<!-------------------------------------------------- SI/NO es alergico a algo ------------------------------------------------------------>                             
                                            ...
                                            <div class="form-group">
                                             <label for="sufrio_accidentes">¿Ha sufrido algún tipo de accidente o convulsiones?</label> 
                                                <div class="row">
                                                    <div class="col-md-3">
...
<!--XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX Problemas de Oido XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->
                                            ...
                                            <div class="form-group">
                                             <label for="problemas_oido">¿Escucha bien?</label> 
                                                <div class="row">
                                                    <div class="col-md-3">
...
<!--XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX REFERENCIA CDI XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->
                                            <div class="form-group">
                                             <label for="referencia_cdi_ninio">¿Cuál fue el motivo de su elección?</label> 
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <select class="form-control" id="referencia_cdi_ninio" name="referencia_cdi_ninio" requred>
                                                            <option value="seleccione">Seleccione</option>
                                                ...
                                                <div class="row">                             
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="nombres_user" id="nombres_user" required>
                                                            <option value="">Seleccione</option>
                                                                <?php
