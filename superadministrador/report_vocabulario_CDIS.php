                                    ...
                                    <tbody>
                                        ...
                                        while ($get_row = mysqli_fetch_array($get_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="../reportes_pdf/pdf_lista_vocabulario_CDIS.php?edit=<?php echo $repor_id; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" target="_blank" class="btn btn-primary btn-sm">Reporte</i></a></center></td>
