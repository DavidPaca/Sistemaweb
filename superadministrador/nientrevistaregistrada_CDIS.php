...
if (isset($_GET['del'])) {
   ...
   // if (mysqli_num_rows($del_check_run) > 0) {
        $del_query = "UPDATE tbl_datos_personales_ninio SET estado_ei= 0 WHERE id_ninio= $del_id";
...
if (isset($_GET['del'])) {
   ...
   // $del_check_query = "SELECT * FROM tbl_datos_personales_ninio ORDER BY id_ninio DESC";
    //$del_check_run = mysqli_query($con, $del_check_query);
   // if (mysqli_num_rows($del_check_run) > 0) {
    $del_query_ei = "DELETE FROM tbl_entrevista_inicial WHERE tbl_entrevista_inicial.id_ninio = $del_id";

   //     $query_documento_identidad = "SELECT detalle FROM tbl_documento_identidad WHERE id = $idTipodocumento ";
        //if (isset($_SESSION['username']) && $_SESSION['role'] == 'admin') {
            if (mysqli_query($con, $del_query_ei)) {
                //header('Location: niniosregistrados.php');
                $msg = "Registro eliminado";
            } else {
                $error = "Registro no eliminado";
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <li><a href="menuprincipal_ei_CDIS.php?numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="fas fa-chevron-left"></i> Regresar</a></li> 
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($run)) {
                                       ...
                                       // $idTipodocumento = $row['detalle_di'];
                                        ...
                                        $estado_en_inicial = ($row['estado_ei']); 
                                        //echo $estado_en_inicial;
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                          ...
                                          <!--    -->
                                           <?php
                                        if ($estado_en_inicial == 1){ ?>
                                           <td><a href="profile_entrevista_inicial_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-file-alt"></i></a></td>
                                          ...
                                          <?php
                                        if ($estado_en_inicial == 1){ ?>
                                            <td><a href="editar_entrevista_inicial_CDIS.php?edit=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>"><i class="far fa-edit"></i></a></td>
                                            ...
                                            <td><a href="nientrevistaregistrada_CDIS.php?del=<?php echo $idninio; ?>&numcdi=<?php echo $num_cdi; ?>&numper=<?php echo $num_per; ?>" onclick="return confirm('¿Desea Borrar?');"><i class="fas fa-trash-alt"></i></a></td>
