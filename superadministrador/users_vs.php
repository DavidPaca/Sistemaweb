    ...
    <?php require_once('inc/header.php'); ?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-users"></i> Usuario: Trabajadora Social <small>Ver todos</small></h1><hr>
                    <ol class="breadcrumb">
                       <li><a href="../admin/index.php"><i class="fas fa-home"></i> Menú</a></li>    
                        <li class="active"><i class="fa fa-users"></i> Trabajadora Social</li>
                    </ol>
                    <?php
                    ...
                    WHERE tbl_usuario.tipo = '3' AND estado_us = 'Activo' ORDER BY apellidos ASC";
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <a href="add-user_vs.php" class="btn btn-primary">Agregar Nuevo</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    while ($row = mysqli_fetch_array($run)) {
                                        ...
                                        <tr>
                                           ...
                                           <!-- <td><?php// echo $tipo_docum; ?></td>  -->
                                            ...
                                            <td><a href="users_vs.php?del=<?php echo $id_ni; ?>" onclick="return confirm('¿Desea Borrar?');" ><i class="fas fa-trash-alt"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
