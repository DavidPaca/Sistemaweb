    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-user-plus"></i> Agregar<small> Nuevo Administrador(a)</small></h1><hr>
                    <ol class="breadcrumb">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                             ...
                             <!--   <div class="form-group">
                                ...
                                <label for="role">Tipo de usuario :</label>
                                    ...
                                    <option value="" >Seleccione</option>
                                        <?php
                                            $sql_usuario_nom = "SELECT * FROM `tbl_usuario_nombre` WHERE id_usuario_nombre != 1 AND id_usuario_nombre != 2 AND id_usuario_nombre != 3 AND id_usuario_nombre != 5 AND id_usuario_nombre != 6 ";
...
<!--............................................estado........................................................-->
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="" >Seleccione</option>
                                        <?php
                                            $sql_cdi = "SELECT * FROM `tbl_cdi` WHERE id != 100 AND id != 101 AND id != 102";
