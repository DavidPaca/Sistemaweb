                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="row">                                       
                                        ...
                                        <a href="edit_user_cg_vs_num_cedula.php?edit=<?php echo $edit_id; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="telef" name="telef" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" value="<?php echo($telefono);?>"  placeholder="Teléfono">
                                </div>
