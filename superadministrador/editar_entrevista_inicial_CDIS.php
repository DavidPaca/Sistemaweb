    ...
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fas fa-user-edit"></i> Editar<small>/Entrevista Inicial del Niño </small></h1><hr>
                    <ol class="breadcrumb">
                  ...
                  <select class="form-control" name="ti_docide" id="categories">   -->
                      <?php
                        /*  $sql_tdocu = "select * from tbl_documento_identidad ";
                          $ejecutar = mysqli_query($con, $sql_tdocu);
                                        ...
                                        <!--        <div class="row">                             
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="nombres_user" id="nombres_user">
                                                            <option value="">Seleccione</option> -->
                                                                <?php
                                                          /*      $sql_user = "SELECT * FROM tbl_usuario WHERE id_cdi = $num_cdi AND id_periodo_usuario = $num_per";
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <option value="">Seleccione</option>  -->
                                                             ...
                                                             /*   $sql_tipo = "SELECT tbl_usuario_nombre.id_usuario_nombre, tbl_usuario_nombre.detalle
                                                                ...
                                                                WHERE tbl_usuario.id_cdi = $num_cdi AND tbl_usuario.id_periodo_usuario = $num_per";
                                        ...
                                        <!--    <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-8" >
                                                        ...
                                                        <input type="text" id="rol_usuario" name="rol_usuario" class="form-control"  value="<?php   
                                                        //echo $tipo_user_ei;                                    
                                                        ?>">
                                                    </div>
                                                </div>                                 
